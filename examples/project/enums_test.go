...
func TestEnums(t *testing.T) {
	t.Run("AccountState", func(t *testing.T) {
		...
		t.Run("Missing Serializers", func(t *testing.T) {
			utils.AssertMissingSerializationInterfacesFor[AccountState](t, []string{"binary-str", "graphql", "text", "yaml", "yaml.v3"})
		})
	...
	t.Run("CountryCode", func(t *testing.T) {
		...
		t.Run("Serialization", func(t *testing.T) {
			...
			for idx, tC := range testCases {
				serializers := []string{"binary-str", "graphql", "json", "sql", "text", "yaml"}
