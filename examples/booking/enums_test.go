...
func TestEnums(t *testing.T) {
	t.Run("BookingState", func(t *testing.T) {
		t.Run("Value Sets", func(t *testing.T) {
			...
			t.Run("additional data", func(t *testing.T) {
				...
				for _, enum := range BookingStateValues() {
					require.Equal(t, descriptions[enum], enum.GetDescription())
				}
		...
		t.Run("Lookup", func(t *testing.T) {
			...
			for idx, tC := range testCases {
				t.Run(fmt.Sprintf("Case-sensitive lookup (idx: %d %s)", idx, tC.enum), func(t *testing.T) {
					...
					require.Equal(t, tC.canonical, enum.GetDescription())
		...
		t.Run("Missing Serializers", func(t *testing.T) {
			utils.AssertMissingSerializationInterfacesFor[BookingState](t, []string{"binary-str", "graphql", "json", "sql", "text"})
		})
	...
	t.Run("BookingStateWithConfig", func(t *testing.T) {
		...
		t.Run("Missing Serializers", func(t *testing.T) {
			utils.AssertMissingSerializationInterfacesFor[BookingStateWithConfig](t, []string{"binary-str", "graphql", "sql", "text"})
		})
		t.Run("Serialization", func(t *testing.T) {
			cfg := utils.TestConfig{}
	...
	t.Run("BookingStateWithConstants", func(t *testing.T) {
		...
		t.Run("Missing Serializers", func(t *testing.T) {
			utils.AssertMissingSerializationInterfacesFor[BookingStateWithConstants](t, []string{"binary-str", "graphql", "json", "sql", "text"})
		})
		t.Run("Serialization", func(t *testing.T) {
			cfg := utils.TestConfig{}
